...
%%% Essentials
\name{Ravi}{Shankar}
\address{263-Patel Hostel, MNNIT Allahabad, Allahabad-211004 U.P. India}
\mobile{(+91) 7571872733} 
%%% Social
\email{ravishankarkumar@live.com}
\homepage{www.ravishankarkumar.com}
\github{ravishankarkumar}
% \linkedin{posquit0}
%%% Optionals
\position{B.Tech(CS) Final year{\enskip\cdotp\enskip}Node.js Developer}
\quote{``To Change lives of the people."}
